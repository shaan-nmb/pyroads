...
This script is the write extracted linemarking data from the 
...
def blobData():
    ...
    try:
        ...
        df2=pd.read_csv("C:\\NMB\Data\\LineMarkingSchema.csv")
...
if __name__ =="__main__":
    ...
    BLOBNAME = "Line Marking/"+BLOBNAME
